...
def randomfacet_analytic(uso, n, vertices=None):
    """
    ...
    # helper function that returns n! times the expected runtime of RANDOMFACET
    @memoize(cache)
    def RF(vertex, cube):
        #if n == 0:
        #if vertex == cube:
...
def randomfacet_sample(uso, N):
    ...
    return RF(int_to_vertex(v, N), cube)[0]
